...
from app.platform.plates.db_plates.sqlite.config import SQLitePlate
from app.platform.plates.db_plates.postgres.config import PostgresPlate
from app.platform.plates.db_plates.postgres.supabase_config import SupabasePlate
from app.platform.plates.db_plates.mongo.config import MongoPlate
from app.platform.infra.redis import RedisSettings, get_redis_settings
from app.platform.infra.caching import init_cache
from app.platform.plates.abstract_plates import DatabasePlate, AuthPlate
from app.platform.plates.auth_plates.local.config import LocalPlate
from app.platform.plates.auth_plates.keycloak.config import KeycloakPlate
from app.platform.plates.auth_plates.auth0.config import Auth0Plate
